...
- Richer syntax diagnostics, grammar-derived keyword completion, grammar-derived keyword hover, document-local identifier completion for requirements-defined `.ssd` reference fields, and top-level document symbols
...
- Identifier hover, explanation-rich hover, rename, formatting, code actions, and semantic tokens
